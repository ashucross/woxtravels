                ...
                <div class="modal-header">
                    ...
                    <div class="pdbx_pop">
                        ...
                        <div class="d-flex flx_hv">
                            <div class="email_box">
                                <label>
                                    <i class="fa fa-language mr-1" aria-hidden="true"></i>Language </label>
                                <div class="position-relative">
                                    <select class="login_input" aria-invalid="false" id="culture-selector-locale" name="locale">
                            ...
                            <div class="email_box">
                                <label>
                                    <i class="fa fa-globe mr-1" aria-hidden="true"></i>Country / Region <p>Selecting the country you’re in will give you local deals and information. </p>
                                </label>
                                <div class="position-relative">
                                    <select class="login_input" aria-invalid="false" id="culture-selector-market" name="market">
                            ...
                            <div class="email_box">
                                <label>
                                    <i class="fa fa-money mr-1" aria-hidden="true"></i> Currency </label>
                                <div class="position-relative">
                                    <select class="login_input" aria-invalid="false" id="culture-selector-currency" name="currency">
