            ...
            <div class="listingbx">
                ...
                <div class="rightlist flexdrop">
                    <h2>{{getdestinationName($params["location"]) ??
                        ""}}&nbsp;&nbsp;:&nbsp;&nbsp;<span>{{!empty($search_hotels) && count($search_hotels) > 0 ?
                            count($search_hotels) : 0 }} hotels available</span>
                 ...
                 $image = !empty($hotel['images'])  ? $hotel['images'] : ''; ?>
                    <div class="lglist">
                        <div class="list_hotel_img">
                            <div class="lgzoomimg">
                                <a href="#">
                                    <img src="{{!empty($image) ? $image : asset('public/assets/images/hotel1.png')}}"
                                        class="img-res" />
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="pribtns">
                            ...
                            <div class="hotslc">
                                <a href="{{url('hotelDetails' . '/' .$hotel['response_data'] . '/' .  $totalPer)}}"
                                    class="btn-grad ftbtn_src">Book Now<i class="fa fa-angle-right ml5"
