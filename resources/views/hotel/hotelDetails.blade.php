    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                    ...
                    <div class="lglist">
                        ...
                        <div class="list_hotel_txt">
                            <div class="listing_hd_hotel">
                                ...
                                <div class="green_ex">
                                    <span><i class="fa fa-star"></i>&nbsp;{{ $hotelDetailsFind->ranking }} (48 reviews)</span>
                                </div>
                            </div>
                        </div>
                        <div class="pribtns">
                            ...
                            <div class="hotslc">
                                ...
                                <form method="post" action="{{ url('/hotel/review') }} ">
                                    ...
                                    {{-- <input type="hidden" name="FS_sessionid"
                                        value="{{ $hotelDetails->FS_sessionid }}"> --}}
                                    <button type="submit" data-id="{{ $rate->rateKey }}" data-hotel={{
                                        $hotelDetails['code'] }} class="btn-grad ftbtn_src booked_btn">Book Now<i
            ...
            <section class="Amenitiesbx page-section" id="section3">
                @if(isset($hotelDetailsFind->facilities))
                <div class="amtbox">
                    ...
                    <div class="amt_icon d-flex flex-wrap">
                        ...
                        @endphp
                    @foreach ($first_ten_keys as $facilities)
                    @php
                    // dd($hotelDetailsFind);
                    ...
                    @endphp
                        <div class="amities_rpt d-flex">
                            <span class="imgblack"><img src="{{url($img)}}" alt=""
                                    class="imgres " /></span>
                            <span class="imagewhite"><img src="{{url($img)}}" alt=""
                                    class="imgres " /></span>
                            <h3>{{  $facilities->description->content }}</h3>
                            {{-- <h3>{{  $facilities->facilityCode }}</h3> --}}
                        </div>
                        @endforeach
                      ...
                      {{--   <div class="amities_rpt d-flex">
                        ...
                        <div class="amities_rpt d-flex">
                            <span class="imgblack"><img src="images/AirConditioning_b.svg" alt=""
                                    class="imgres " /></span>
                            <span class="imagewhite"><img src="images/AirConditioning_w.svg" alt=""
                                    class="imgres " /></span>
