...
<hr style="width:100%;">
    <div class="row pdrs">
        <div class="col-sm-4 ">
            <div class="inpse wds">
                ...
                <div class="d-flex">
                    ...
                    <div class="inpes">
                        <input type="hidden" name="{{ $name }}[{{$a}}][travelerId]" value="{{ $value['travelerId']}}" />

                        <input class="form-input" type="text" name="{{ $name }}[{{$a}}][first_name]"
        ...
        <div class="col-sm-4">
            <div class="inpse">
                <label class="md_none">&nbsp;</label>
                <input type="text" class="form-input" name="{{ $name }}[{{$a}}][last_name]" placeholder="Last Name">
            </div>
        </div>
        <div class="col-sm-4">
            <div class="inpse">
        ...
        <div class="col-sm-4">
            <div class="inpse">
                <label class="md_none">&nbsp;</label>
                <div class="slcbs">
                    <select class="form-input" id="gender{{ $name.$a  }}" name="{{ $name }}[{{$a}}][gender]">
