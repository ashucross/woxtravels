...
$ADT=$CHD=$INF=0;
for($a=0;$a<$Passenegrcount;$a++){ if($a < $adult){ $name='adult' ; $p=++$ADT; }else if($a>=
    $adult && ($a < ($adult + $Child))){ $name='child' ; $p=++$CHD; }elseif($a>= ($adult + $Child)){
        $name = 'infant';
        $p = ++$INF;
        }
        @endphp
        ...
        <div class="row pdrs">
                    ...
                    <div class="d-flex">
                        <div class="droptitle slcbs">
                            <select class="sltclick">
                                <option hidden data-ioshidden value="" name="title{{  $name }}[]" id="hideclick{{ $name.$a  }}">Title
                                </option>
                                <option>Mr</option>
                                <option>Ms</option>
                                <option>Mrs</option>
                        ...
                        <div class="inpes">
                            <input class="form-input" type="text" name="first_name{{  $name }}[]" placeholder="First Name">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="inpse ">
                    ...
                    <input type="text" class="form-input" name="middel_name{{  $name }}[]" placeholder="Middle Name">
                </div>
            </div>
            <div class="col-sm-4">
                <div class="inpse">
                    <label class="md_none">&nbsp;</label>
                    <input type="text" class="form-input" name="last_name{{  $name }}[]" placeholder="Last Name">
                </div>
            </div>
            <div class="col-sm-4">
                <div class="inpse">
                    ...
                    <div class="dttrhee">
                        <div class="sltnox slcbs">
                            <select id="date_of_birth{{ $name.$a  }}" name="date_of_birth{{  $name }}[]" onchange="change_year(this)">
                        ...
                        <div class="sltnox slcbs">
                            <select id="date_of_month{{ $name.$a  }}" name="date_of_month{{  $name }}[]" onchange="change_month(this)">
                        ...
                        <div class="sltnox slcbs">
                            <select id="date_of_birst_Day{{ $name.$a  }}" name="date_of_birst_Day{{  $name }}[]">
            ...
            <div class="col-sm-4">
                <div class="inpse">
                    <label class="md_none">&nbsp;</label>
                    <div class="slcbs">
                        <select class="form-input" id="gender{{ $name.$a  }}" name="gender{{  $name }}[]">
            ...
            <div class="col-sm-4">
                <div class="inpse ">
                    ...
                    <div class="slcbs">
                        <select class="form-input" id="nationality{{ $name.$a  }}" name="nationality{{  $name }}[]">
    ...
    @include('flight.pasport-details')
    @php
    }
    @endphp
