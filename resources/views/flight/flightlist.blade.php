@extends('homeLayout') @section('styles')
<!-- page specific style code here-->
<!-- page specific style code here-->
@endsection
@section('pageContent') <div class="modifyhead">
    ...
    <div class="container_pd">
        <div class="modifysection">
            <div class="mdtxt">
                <ul class="flx_md">
                    <li class="spcmd">
                        ...
                        <i class="fa fa-exchange cliclkmd"></i>
                        <span>Murtala Muhammed Inter</span>
                    </li>
                    <li>
                        <span>Feb 11, 2022&nbsp;-&nbsp;Mar 5, 2022</span>
                    </li>
                    <li>
            ...
            <div class="mdbtn">
                <button type="button" class="mod_bt cliclkmd">
                    <i class="fa fa-edit"></i>
                    <span class="mdf_ms ">Modify <i class="fa fa-angle-down ml-1"></i>
                    </span>
                </button>
            </div>
        </div>
    </div>
    <section class="search_box gapbox position-relative clearfix" style="display: none;" id="slidesearch">
        <div class="tabsearch ">
                        ...
                        <div class="boxsearching ">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div class="dropdown-menu drp_plane">
                                                <div class="plane_list">
                                                    <span>Search</span>
                                                    <ul id="round-autocomplete-source">
                                    ...
                                    <div class="Towhere ">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div class="dropdown-menu drp_plane">
                                                <div class="plane_list">
                                                    <span>Search</span>
                                                    <ul id="round-autocomplete-destination">
                            ...
                            <div class="searchbtn d-flex">
                                ...
                                <button type="submit" class="btn-grad ftbtn_src" id="btn-search-flight">
                                    <i class="fa fa-paper-plane-o mr-2" aria-hidden="true"></i>Seach Flights </button>
                            </div>
                        </div>
                    </form>
                </article>
...
<div class="container_pd">
    <section class="list_fliter">
        <div class="filterbx">
            ...
            <div class="filtercnt">
                <div class="mobileapply_ftr">
                    <button type="button" class="btnf_apy" id="aplybtn">
                        <span>0 Filters</span>APPLY </button>
                </div>
                <div class="panel-group " id="accordion">
                            ...
                            <div class="panel-body">
                                <div class="rage_price">
                                    ...
                                    <div class="d-flex justify-content-between slider-labels">
                                        <div class=" caption">
                                            <strong>Min:</strong>
                                            <span id="slider-range-value1">{{$price['MinPrice']}}</span>
                                        </div>
                                        <div class=" text-right caption">
                                            <strong>Max:</strong>
                                            <span id="slider-range-value2">{{$price['MaxPrice']}}</span>
                                        </div>
                                    </div>
                                    <!-- <form> -->
                                    <input type="hidden" id="min-value" name="min-value" value="{{$price['MinPrice']}}">
                                    <input type="hidden" id="max-value" name="max-value" value="{{$price['MaxPrice']}}">
                                    <!-- </form> -->
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="STOPS" class="panel-collapse collapse show">
                            <div class="panel-body pdmrbx">
                                <div class="priceul">
                                    <ul class="listps">
                                        <li>
                                            <a href="#" class="activeck">
                                                <span>0</span> ${{number_format($Stops['0stop'][0]->price)}} </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <span>1</span> ${{number_format($Stops['1stop'][0]->price)}} </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <span>1+</span> ${{number_format($Stops['1+stop'][0]->price)}} </a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="AIRLINE" class="panel-collapse collapse show">
                            <div class="panel-body pdmrbx">
                                <div class="checkftr">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="FLEXIBILITY" class="panel-collapse collapse show">
                            <div class="panel-body pdmrbx">
                                <div class="checkftr">
                                    <ul class="check-boxes-custom list-checkboxes">
                                        <li>
        ...
        <div class="listingbx">
            <div class="rightlist">
                <h2>Flights from <span>{{$Location['source']}} to {{$Location['destination']}}</span>
                </h2>
            </div>
            <div class="row bgsl">
                <div class="col-sm-2 ligbtm">
                                ...
                                <a href="#">
                                    <div class="listdh">
                                        <div class="airline-logo1">
                                            <div class="imglsdh">
                                                <img src="{{asset('public/assets/images/AF.gif')}}" class="img-res" />
                                            </div>
                                        ...
                                        <div class="listnb">
                                            <ul class="list-unstyleds">
                                                <li>
                                                    <span class="stopmd">Nonstop</span> &nbsp;
                                                </li>
                                                <li>
                                                    <span class="stopmd">1 Stop</span>
                                                    <i class="fa fa-usd mr-1"></i>511,656
                                                </li>
                                                <li>
                                                    <span class="stopmd">1+ Stops</span>
                                                    <i class="fa fa-usd mr-1"></i>621,816
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#Cheapest">
                                <div class="tbcps d-flex align-items-center">
                                    ...
                                    <div class="textcps">
                                        <h4>Cheapest</h4>
                                        <span>From ${{number_format($Stops['0stop'][0]->price)}}</span>
                                    </div>
                                </div>
                            </a>
                        </li>
...
<script>
    $(document).ready(function() {
        ...
        $(".cliclkmd").click(function() {
            $("#slidesearch").slideToggle("slow");
        });
        $(".mod_bt").click(function() {
            $(".mod_bt").toggleClass("rots");
        });
        $(".seeclick").click(function() {
    ...
    $(document).ready(function() {
        ...
        rangeSlider.noUiSlider.on('update', function(values, handle) {
            ...
            $('.flight-li').each(function(i, obj) {
                // $(obj).attr("price");
                //console.log('values0' + moneyFormat.from(values[0]) + 'values1' + moneyFormat.from(values[1]));
                if (parseInt($(obj).attr("price")) > low && parseInt($(obj).attr("price")) < high) {
                    console.log(parseInt($(obj).attr("price")) + 'is between ' + low + ' and' + high);
                    $(obj).show();

                } else {
                    console.log(parseInt($(obj).attr("price")) + 'is not between ' + low + ' and' + high);
                    // // console.log('not' + $(obj).attr("price"));
                    $(obj).hide();
                }
