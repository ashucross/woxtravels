...
$(window).on("load", function () {
   var details =  localStorage.getItem('travelers-details');
   console.log(details);
   if(details){
...
<style>
    ...
    .se-pre-con {
        ...
        height: 100%;
        z-index: 9999;
        background: url(/img/Rolling-1s-48px.gif) center no-repeat #fff;
    }
    ...
    <div class="container">
        <div class="listoption">
            <ul>
                ...
                <!-- <li>
							<span><img src="/images/Payment-Mode.png"
									class="img-res"></span>
    ...
    <div class="detailsmain">
        <div class="leftmain_rv">
            <div class="nofti_gr greenbg">
                <p><i class="fa fa-check-circle"></i>&nbsp;Good job! Book now so you don’t miss out on this price</strong></p>
            </div>
                    ...
                    <li>
                        ...
                        <div class="colps_rv">
                            <div id="ShowFlight2" class="collapse clpside">
                                <div class="heading_cpl">
                                    <h4><i class="fas fa-suitcase-rolling"></i>Flight and Baggage Details</h4>
                                    <div class="suitcase_rv"><span class="suitcase_img"><img src="/images/vistara-logo.jpg" class="img-res"></span><span class="suitcase_txt"><strong>09:30
            ...
            <div class="dts_heading">
            <h1><img src="/images/loginics.svg" class="img-res">&nbsp;Login-in your Travel24hr account</h1>
                <!-- <h1><img src="/images/loginics.svg" class="img-res">&nbsp;Login-in your {{ env('APP_NAME') }} )</h1> -->
                <div class="ds">
                 @if(auth()->check())
                    <a href="#" class="cntds">Continue as Guest</a>
                 @else
                        @if(auth()->guard('agents')->user())
                          <a href="#" class="cntds">Continue as Agent</a>
                        @endif
                           @if(!auth()->guard('agents')->user())
            ...
            <div class="Review_book whitebrd">
                ...
                <div class="row pdrs">
                    <div class="col-sm-4 ">
                        <div class="inpse" >
                            <label>Surname<span class="erfr">*</span></label>
                            <div class="d-flex">
                                <div class="droptitle">
                                <select>
...
$(document).ready(function(){
    ...
    $('#day,#day1,#day2').append(option);
    $('#day,#day1,#day2').val(selectedDay);
    ...
    $('#month,#month1,#month2').append(option);
    $('#month,#month1,#month2').val(selectedMon);
    ...
    $('#year,#year1,#year2').append(option);
    $('#year,#year1,#year2').val(selectedYear);
});
...
function change_month(select) {
    ...
    $(day).val(val);
                ...
                <div class="row pdrs">
                   ...
                   <SELECT  id ="month2" name = "mm" onchange="change_month(this)">
                   </SELECT>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <label for="myCheckbox1" class="brse">
                                        <div class="mels_ck d-flex">
                                            <span><img src="/images/AddMeals.svg" class="img-res"></span>
                                            <h5>Add Meals</h5>
                                        </div>
                                    </label>
                                </li>
                                <li>
                                    ...
                                    <label for="myCheckbox2" class="brse">
                                        <div class="mels_ck d-flex">
                                            <span><img src="/images/AddBaggage.svg" class="img-res"></span>
                                            <h5>Add Baggage</h5>
                                        </div>
                                    </label>
                                </li>
                                ...
                                <li>
                                    ...
                                    <label for="myCheckbox4" class="brse">
                                        <div class="mels_ck d-flex">
                                            <span><img src="/images/Baggageout.svg" class="img-res"></span>
...
<div class="clear"></div>
                ...
                <div class="ctbse">
                <button type="submit" id="booking-details"  class="anchor-btn cntsd_book">Continue to book&nbsp;&nbsp;<i class="fas fa-long-arrow-alt-right"></i></button>
                </div>
            </div>
            </form>
        </div>
    ...
    <div class="modal-content">
     <form id="customer-login-form">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" id="login-form">Save changes</button>
      </div>
        </form>
    </div>
  </div>
