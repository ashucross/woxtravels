...
<?php //echo '<pre>'; print_r($flightresult); die; ?>
	...
	?>																		{{round($newtotal + $mv)}}
		...
		<a class="btn small colorful-transparent hover-colorful btn_green" href="{{URL::to('/Review/Checkout')}}?tid={{$flightresult->Response->TraceId}}&RIndex={{$res->ResultIndex}}&isINT=true&isReturn=true">Book Now</a>
