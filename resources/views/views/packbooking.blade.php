...
$allprice = \App\PackagePrice::select('twin','single','triple','child_with_bed','child_without_bedbelow12','child_without_bedbelow26','infant')->where('package_id',$packagedetail->id)->whereRaw('json_contains(departure_date, \'["' . $date . '"]\')')->first();
