...
@section('title', 'New Manage Destination')
				...
				<div class="col-md-12">
					<div class="card card-primary">
					  <div class="card-header">
						<h3 class="card-title">New Manage Destination</h3>
					  </div>
					  <!-- /.card-header --> 
					  <!-- form start -->
					  {{ Form::open(array('url' => 'destination/store', 'name'=>"add-destination", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")) }}
						<div class="card-body">
							<div class="form-group" style="text-align:right;">
								...
								{{ Form::button('<i class="fa fa-save"></i> Save Destination', ['class'=>'btn btn-primary', 'onClick'=>'customValidate("add-destination")' ]) }}
							</div> 	 
						  ...
						  {{-- <div class="form-group row"> 
								...
								<div class="col-sm-10">
								{{ Form::text('dest_name', '', array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Enter Dest Name' )) }}
