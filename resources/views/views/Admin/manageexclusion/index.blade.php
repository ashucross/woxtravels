...
@section('title', 'Manage Exclusion')
					...
					<div class="card"> 
						<div class="card-header">  
							<div class="card-title">  
								<a href="{{route('admin.manageexclusion.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> New Exclusion</a>
								  ...
								  <td>
									<div class="nav-item dropdown action_dropdown">
										...
										<div class="dropdown-menu">
											<a href="{{URL::to('/exclusion/edit/'.base64_encode(convert_uuencode(@$list->id)))}}"><i class="fa fa-edit"></i> Edit</a>
