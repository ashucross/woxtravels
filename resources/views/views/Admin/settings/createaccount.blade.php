			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="card card-primary">
					  ...
					  <!-- /.card-header -->
					  <!-- form start -->
					  {{ Form::open(array('url' => 'bank-accounts/store', 'name'=>"add-city", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")) }}
						<div class="card-body">
							<div class="row">
								<div class="col-sm-4 ">
									<div class="form-group"> 
										<label for="company_bank_name" class="col-form-label">Company's Bank Name <span style="color:#ff0000;">*</span></label>
										{{ Form::text('company_bank_name', '', array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'' )) }}
								...
								<div class="col-sm-4  ">
									...
									{{ Form::text('account_no', '', array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'' )) }}
								...
								<div class="col-sm-4  ">
									...
									{{ Form::text('bank_name', '', array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'' )) }}
								...
								<div class="col-sm-4  ">
									...
									{{ Form::text('bank_address', '', array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'' )) }}
								...
								<div class="col-sm-4  ">
									...
									{{ Form::text('bank_city', '', array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'' )) }}
								...
								<div class="col-sm-4  ">
									...
									{{ Form::text('postal_code', '', array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'' )) }}
								...
								<div class="col-sm-4  ">
									...
									{{ Form::text('ifsc_code', '', array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'' )) }}
								...
								<div class="col-sm-4  ">
									...
									{{ Form::text('swift_code', '', array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'' )) }}
