...
<div class="content-wrapper">
	...
	<!-- Main content --> 
	<section class="content return_setting custom_setting">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<!-- Flash Message Start -->
					...
					<div class="card">
						<div class="card-body p-0" style="display: block;">
							<ul class="nav nav-pills flex-column"> <!---->
								<li class="nav-item"> <a href="{{route('admin.taxrates')}}" id="ember5167" class="nav-link ember-view"> Tax Rates </a> </li><!----><!----><!----><!----><li class="nav-item"> <a href="{{route('admin.returnsetting')}}" id="ember5168" class="nav-link active ember-view"> GST Settings </a> </li>
							</ul>
						</div>
					</div>
				</div>
							...
							<div class="row">
								...
								<div class="col-sm-12">
									<div class="form-group form_label"> 
										<label for="" class="col-form-label" style="margin-right:10px;">Is your business registered for GST?</label>
										<label for="" class="" style="margin-right:10px;"><input type="radio" value="yes" <?php if(@Auth::user()->is_business_gst == 'yes'){ echo 'checked'; } ?> name="is_business_gst"> Yes</label>
