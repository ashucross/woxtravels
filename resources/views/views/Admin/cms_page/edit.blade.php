			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="card card-primary">
					  ...
					  <!-- /.card-header -->
					  <!-- form start -->
					  {{ Form::open(array('url' => 'cms_pages/edit', 'name'=>"edit-template", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")) }}
					   {{ Form::hidden('id', @$fetchedData->id) }}
						<div class="card-body">
						  ...
						  <div class="form-group row">
						   ...
						   <div class="form-group row">
								<label for="is_sidebar" class="col-sm-2 col-form-label">Sidebar</label>
								<div class="col-sm-10">
									<input value="1" type="checkbox" name="is_sidebar" {{ (@$fetchedData->is_sidebar == 1 ? 'checked' : '')}} data-bootstrap-switch>
									@if ($errors->has('is_sidebar'))
										<span class="custom-error" role="alert">
											<strong>{{ @$errors->first('is_sidebar') }}</strong>
										</span>  
									@endif
								</div> 
						  </div>
