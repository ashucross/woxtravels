			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="card card-primary">
					  ...
					  <!-- /.card-header -->
					  <!-- form start -->
					  {{ Form::open(array('url' => 'cms_pages/store', 'name'=>"add-template", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")) }}
						...
						<div class="card-body">
						  ...
						  <div class="form-group row">
								...
								<div class="col-sm-10">
									<input value="1" type="checkbox" name="is_sidebar" checked data-bootstrap-switch>
