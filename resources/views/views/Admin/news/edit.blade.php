			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="card card-primary">
					  ...
					  <!-- /.card-header -->
					  <!-- form start -->
					  {{ Form::open(array('url' => 'news/edit', 'name'=>"edit-template", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")) }}
					   {{ Form::hidden('id', @$fetchedData->id) }}
						<div class="card-body">
							<div class="form-group" style="text-align:right;">
								...
								{{ Form::button('<i class="fa fa-save"></i> Update Blog', ['class'=>'btn btn-primary', 'onClick'=>'customValidate("edit-template")' ]) }}
							</div>
