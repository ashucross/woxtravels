										...
										<tr id="id_{{@$list->id}}">
											...
											<div class="nav-item dropdown action_dropdown">
												...
												@if(@in_array('edit_lead', $modules))
												  <a href="{{URL::to('/leads/edit/'.base64_encode(convert_uuencode(@$list->id)))}}"><i class="fa fa-edit"></i> Edit</a>
											   @endif
											   @if(@in_array('lead_history', $modules))
												  <a href="{{URL::to('/leads/history/'.base64_encode(convert_uuencode(@$list->id)))}}"><i class="fa fa-history"></i> History</a>
											  @endif
