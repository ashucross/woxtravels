								  ...
								  <td>
									<div class="nav-item dropdown action_dropdown">
										...
										<div class="dropdown-menu">
											<a href="{{URL::to('/flight-detail/edit/'.base64_encode(convert_uuencode(@$list->id)))}}"><i class="fa fa-edit"></i> Edit</a>
											<a href="{{URL::to('/flight-detail/clone/'.base64_encode(convert_uuencode(@$list->id)))}}"><i class="fa fa-copy"></i> Clone</a>
											
										</div>
									</div> 
								  </td>
								  <td>{{ @$list->flight->name == "" ? config('constants.empty') : str_limit(@$list->flight->name, '50', '...') }}</td> 
								   <td>@if(@$list->flighttype == 1)Oneway Trip @else Round Trip @endif</td> 
		...
		<div class="modal-content">
			...
			<form action="{{route('admin.agents.index')}}" method="get">
				<div class="modal-body"> 
					...
					<div class="col-md-6">
						<div class="form-group row">
							...
							<div class="col-sm-9">
								{{ Form::text('flight_name', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Flight Name', 'id' => '' )) }}
							</div>
						</div>
					</div>
					<div class="col-md-6">
							<div class="form-group row">
								...
								<div class="col-sm-9">
									{{ Form::text('flight_type', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Flight Type', 'id' => '' )) }}
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group row">
								...
								<div class="col-sm-9">
									{{ Form::text('agent', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Agent', 'id' => '' )) }}
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group row">
								...
								<div class="col-sm-9">
									{{ Form::text('flight_code', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Flight Code', 'id' => '' )) }}
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group row">
								...
								<div class="col-sm-9">
									{{ Form::text('depature_time', '', array('class' => 'form-control commodate', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Departure Time', 'id' => '' )) }}
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group row">
								...
								<div class="col-sm-9">
									{{ Form::text('arrival_time', '', array('class' => 'form-control commodate', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Arrival Time', 'id' => '' )) }}
								</div>
							</div>
						</div>
					</div>
				...
				<div class="modal-footer justify-content-between">
				  <a href="{{route('admin.agents.index')}}" class="btn btn-default" >Reset</a>
