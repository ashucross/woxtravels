						...
						<div class="card-header">  
							...
							<div class="print_export" style="margin-top: 15px;">
								<ul>
									...
									<li class="export"><a href="{{URL::to('/wallet/excel_waller_log')}}?agent={{@$_GET['agent']}}&rdate={{@$_GET['rdate']}}&date={{@$_GET['date']}}&mode={{@$_GET['mode']}}&transaction_id={{@$_GET['transaction_id']}}&status={{@$_GET['status']}}"><i class="fas fa-file-excel"></i> Export</a></li>
								</ul>
							</div>
						</div>  
								  ...
								  <td>
									<div class="nav-item dropdown action_dropdown cus_action_btn">
										...
										<div class="dropdown-menu">
											<a href="{{URL::to('/wallet/view/'.base64_encode(convert_uuencode(@$list->id)))}}"><i class="fa fa-eye"></i> View Detail</a>
...
$(document).delegate('.walletar', "click", function () {
			$('#walletpopup_modal').modal('show');	
				...
				$.ajax({
					type:'get',
					url:'{{URL::to('wallet/edit/')}}/'+vid+'?type='+v,
					processData: false,
					contentType: false,
