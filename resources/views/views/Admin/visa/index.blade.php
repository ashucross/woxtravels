							...
							<table id="hoteltable" class="table table-bordered table-hover text-nowrap">
							  <thead>
								...
								<tr id="id_{{@$list->id}}">  
								  ...
								  <td>{{ @$list->code }}</td> 
								  <td><img width="30" src="{{URL::to('/public/img/airline')}}/{{@strtoupper($list->code)}}.gif"></td> 
								  ...
								  <td>
									<div class="nav-item dropdown action_dropdown">
										...
										<div class="dropdown-menu">
											<a href="{{URL::to('/flights/edit/'.base64_encode(convert_uuencode(@$list->id)))}}"><i class="fa fa-edit"></i> Edit</a>
