							...
							<div class="mailbox-controls">
								...
								<div class="more_btn_group">
									...
									<div class="dropdown-menu" x-placement="top-start">
									  ...
									  <a class="dropdown-item" tabindex="-1" href="#">Export as PDF</a>
											...
											<tr>
												<td class="check_td">
												  <div class="icheck-primary">
													<input type="checkbox" name="invoicelist[]" class="seleccheckbox" value="" id="check{{@$list->id}}">
					...
					<div class="card card-primary card-outline invoice_list">
						...
						<div class="card-body p-0">
							<div class="custom_card_header">
								<a href="{{URL::to('/invoice/edit/'.base64_encode(convert_uuencode(@$invoicedetail->id)))}}" class="btn btn-inline-block btn-sm cus_btn"><i class="fa fa-edit"></i> Edit</a>  
								<div class="more_btn_group">
									...
									<div class="dropdown-menu" x-placement="top-start">
									  <a class="dropdown-item" tabindex="-1" href="{{URL::to('/invoice/email/'.base64_encode(convert_uuencode(@$invoicedetail->id)))}}">Send Mail</a>
									</div> 
								</div>
								...
								<div class="more_btn_group">
									...
									<div class="dropdown-menu" x-placement="top-start">
									  <a class="dropdown-item" tabindex="-1" href="{{URL::to('/invoice/download/'.base64_encode(convert_uuencode(@$invoicedetail->id)))}}">PDF</a>
								...
								<div class="more_btn_group">
									...
									<div class="dropdown-menu" x-placement="top-start">
									  <a class="dropdown-item" tabindex="-1" href="{{URL::to('/invoice/reminder/'.base64_encode(convert_uuencode(@$invoicedetail->id)))}}">Send Now</a>
...
<div class="modal fade" id="payment_modal">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			{{ Form::open(array('url' => 'invoice/paymentsave', 'name'=>"add-paymentsave", 'autocomplete'=>'off', "enctype"=>"multipart/form-data", 'id'=>'updatepaymentsave')) }}
...
<div class="modal fade" id="editpaymentmodel">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			{{ Form::open(array('url' => 'invoice/editpaymentsave', 'name'=>"add-paymentsave", 'autocomplete'=>'off', "enctype"=>"multipart/form-data", 'id'=>'editpaymentsave')) }}
			<div class="modal-body">
...
jQuery(document).ready(function($){
	...
	$('#pdfmodel').modal('show');
		...
		$("#pdfmodel .modal-body iframe").attr('src', site_url+'/invoice/print/'+val)
});
</script>
<?php
