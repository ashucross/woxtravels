							  ...
							  <tbody class="tdata">	
							   @if(@$totalData !== 0)
								...
								<tr id="id_{{@$list->id}}"> 
								  ...
								  <td><a href="{{URL::to('/invoice/lists/'.base64_encode(convert_uuencode(@$list->id)))}}">{{$list->invoice}}</a></td> 
								  <td>{{$list->order_id}}</td> 
								  ...
								  <td>
									<div class="nav-item dropdown action_dropdown">
										...
										<div class="dropdown-menu">
											<a href="{{URL::to('/invoice/edit/'.base64_encode(convert_uuencode(@$list->id)))}}"><i class="fa fa-edit"></i> Edit</a>
