								  ...
								  <td>
									<div class="nav-item dropdown action_dropdown">
										...
										<div class="dropdown-menu">
										 <a href="{{URL::to('/holidaypackage/edit/'.base64_encode(convert_uuencode(@$list->id)))}}"><i class="fa fa-edit"></i> Edit</a>
										 <a href="{{URL::to('/holidaypackage/duplicate/'.base64_encode(convert_uuencode(@$list->id)))}}" ><i class="fa fa-clone"></i> Clone</a>
