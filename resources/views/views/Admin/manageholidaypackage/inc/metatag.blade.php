...
<div class="card"> 
	<div class="card-body table-responsive p-0">
		<table id="metatag_table" class="table table-hover text-nowrap">
			...
			?>
			<tr class="countmtlist" id="metatag_<?php echo $im; ?>"><td><?php echo $mtlist->title; ?></td><td><?php echo $mtlist->keyword; ?></td><td><?php echo $mtlist->description; ?></td><td><a class="remove_metatag" id="<?php echo $im; ?>" href="javascript:;"><i class="fa fa-trash"></i></a> / <a href="javascript:;" class="edit_metatag" id="<?php echo $im; ?>"><i class="fa fa-edit"></i></a><input type="hidden" name="all_meta_title[]" value="<?php echo $mtlist->title; ?>"><input type="hidden" name="all_meta_keyword[]" value="<?php echo $mtlist->keyword; ?>"><textarea style="display:none;" type="hidden" name="all_meta_desc[]" value=""><?php echo $mtlist->description; ?></textarea></td></tr>
			<script>
