		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group row">
					...
					<div class="col-sm-10">
						{{ Form::text('imagealt', '', array('class' => 'form-control', 'data-valid'=>'',
						'autocomplete'=>'off','placeholder'=>'Enter Image Alt', 'id' => 'gallery_imagealt' )) }}
				...
				<div class="form-group row">
					...
					<div class="galleryimage_m custom_pack_m"></div>-->
						...
						{{-- <input type="file" name="galleryimage" class="form-control" autocomplete="off"
							data-valid="" />
		...
		<table id="gallery_table" class="table table-hover text-nowrap">
			...
			?>
				...
				<tr class="countgallen" id="gallery_<?php echo $igh; ?>">
					<td>
						<?php echo $galist->package_gallery_image; ?>
					</td>
					<td>
						<?php echo $galist->package_gallery_image_alt; ?>
					</td>
					<td>
						<?php if($fetchggimage && @$fetchggimage->images != ''){ echo '<img width="50" height="50" src="'.URL::to('/public/img/media_gallery').'/'.@$fetchggimage->images.'">'; } ?>
					</td>
					<td><a class="remove_gallery" id="<?php echo $igh; ?>" href="javascript:;"><i
								class="fa fa-trash"></i></a> / <a href="javascript:;" class="edit_gallery"
							id="<?php echo $igh; ?>"><i class="fa fa-edit"></i></a><input type="hidden"
							name="all_gallery_imagealt[]"
							value="<?php echo $galist->package_gallery_image_alt; ?>"><input type="hidden"
							name="all_gallery_imageid[]" value="<?php echo $galist->package_gallery_image; ?>"></td>
				</tr>
