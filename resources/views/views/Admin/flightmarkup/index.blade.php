						...
						<div class="card-body">
							...
							<div class="tab-content" id="custom-tab-content">
								<div class="tab-pane active show" id="domestic" role="tabpanel" aria-labelledby="domestic-tab">
								 {{ Form::open(array('url' => 'flightmarkup/update', 'name'=>"add-domestic", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")) }}
											...
											<ul>
												...
												<input type="hidden" value="b2c" name="user_type"/>
													...
													<div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 31px, 0px);">
													  <a class="dropdown-item" tabindex="-1" href="{{URL::to('/flightmarkup')}}">B2C Markup</a>
													  <a class="dropdown-item" tabindex="-1" href="{{URL::to('/flightmarkup')}}?type=b2b">B2B Markup</a>
													</div>	 										
												</li>
											</ul> 
										</div>
								...
								<div class="tab-pane" id="international" role="tabpanel" aria-labelledby="international-tab">
								 {{ Form::open(array('url' => 'flightmarkup/update', 'name'=>"add-international", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")) }}
