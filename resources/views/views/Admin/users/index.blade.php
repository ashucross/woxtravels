						...
						<div class="card-header">  
							...
							<div class="print_export">
								<ul>
									...
									<li class="export"><a href="{{URL::to('/excel_users_log')}}?first_name={{@$_GET['first_name']}}&last_name={{@$_GET['last_name']}}&from={{@$_GET['from']}}&to={{@$_GET['to']}}&email={{@$_GET['email']}}&status={{@$_GET['status']}}"><i class="fas fa-file-excel"></i> Export</a></li>
								</ul>
							</div>
						</div> 
						...
						<div class="card-body table-responsive p-0">
							<table id="departurecity_table" class="table table-bordered table-hover text-nowrap">
							  ...
							  <tbody class="tdata">	 
								...
								<tr id="id_{{@$list->id}}"> 
									<td><a href="{{URL::to('/users/view/'.base64_encode(convert_uuencode(@$list->id)))}}">{{str_pad($list->id, 4, '0', STR_PAD_LEFT)}}</a></td>
								  ...
								  <td>
									<div class="nav-item dropdown action_dropdown cus_action_btn">
										...
										<div class="dropdown-menu">
											<a href="{{URL::to('/users/view/'.base64_encode(convert_uuencode(@$list->id)))}}"><i class="fa fa-eye"></i> View Detail</a>
											<a href="{{URL::to('/users/send-password/'.base64_encode(convert_uuencode(@$list->id)))}}"><i class="fa fa-edit"></i> Send Password</a>
										</div>
									</div> 								  
								  </td>
								</tr>	
