...
@section('title', 'Edit Manage Addon')
				...
				<div class="col-md-12">
					<div class="card card-primary">
					  <div class="card-header">
						<h3 class="card-title">Edit Manage Addon</h3>
					  </div>
					  <!-- /.card-header -->
					  <!-- form start -->
					  {{ Form::open(array('url' => 'addons/edit', 'name'=>"add-destination", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")) }}
					  {{ Form::hidden('id', @$fetchedData->id) }}
						<div class="card-body">
							<div class="form-group" style="text-align:right;">
								...
								{{ Form::button('<i class="fa fa-edit"></i> Save Addon', ['class'=>'btn btn-primary', 'onClick'=>'customValidate("add-destination")' ]) }}
							</div> 	
							<div class="form-group row">
							<label for="title" class="col-sm-2 col-form-label">Title </label>
							<div class="col-sm-10">
								{{ Form::text('title', @$fetchedData->title, array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )) }}
							</div>
						  </div>
						  {{-- <div class="form-group row">  
						  ...
						  <div class="form-group row">
							...
							<div class="col-sm-10">
								{{ Form::text('price', @$fetchedData->price, array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'', 'onkeypress'=>'return isNumberKey(event)' )) }}
							</div>
						  </div>
						  <div class="form-group row">
							<label for="child_price3" class="col-sm-2 col-form-label">Child Price (3-12)</label>
							<div class="col-sm-10">
								{{ Form::text('child_price3', @$fetchedData->child_price3, array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'', 'onkeypress'=>'return isNumberKey(event)' )) }}
							</div>
						  </div>
						  <div class="form-group row">
							<label for="child_price2" class="col-sm-2 col-form-label">Child Price (2-4)</label>
							<div class="col-sm-10">
								{{ Form::text('child_price2', @$fetchedData->child_price2, array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'', 'onkeypress'=>'return isNumberKey(event)' )) }}
							</div>
						  </div>
						   <div class="form-group row">
							<label for="infant_price" class="col-sm-2 col-form-label">Infant Price (0-2)</label>
							<div class="col-sm-10">
								{{ Form::text('infant_price', @$fetchedData->infant_price, array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'', 'onkeypress'=>'return isNumberKey(event)' )) }}
							</div>
						  </div>
						  <div class="form-group row">
							<label for="duration" class="col-sm-2 col-form-label">Duration </label>
							<div class="col-sm-10">
								{{ Form::text('duration', @$fetchedData->duration, array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )) }}
							</div>
						  </div>
						  <div class="form-group row">
