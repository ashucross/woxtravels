					...
					<div class="card"> 
						<div class="card-header">  
							<div class="card-title">
								<a href="{{route('admin.topinclusion.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> New Top Inclusion</a>
								<a style="display:none;" class="btn btn-primary displayifselected" href="javascript:;" onClick="deleteAllAction('super_top_inclusions')"><i class="fa fa-trash"></i> Delete</a> 
							</div>   
							  ...
							  <thead>
							   ...
							   <tbody class="tdata">	
								...
								<td><input class="checkSingle" type="checkbox" name="allcheckbox" value="{{@$list->id}}"></td>
								  ...
								  <td>@if(@$list->image != '') <img width="30" src="{{URL::to('/public/img/topinclusion_img')}}/{{@$list->image}}" class="img-avatar"/> @endif </td>
								  ...
								  <td>
									<div class="nav-item dropdown action_dropdown">
										...
										<div class="dropdown-menu">
											<a href="{{URL::to('/top-inclusion/edit/'.base64_encode(convert_uuencode(@$list->id)))}}"><i class="fa fa-edit"></i> Edit</a>
...
<div class="modal fade" id="amnetsearch_modal">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<form action="{{route('admin.topinclusion.index')}}" method="get">
				...
				<div class="modal-footer justify-content-between">
				  <a href="{{route('admin.topinclusion.index')}}" class="btn btn-default" >Reset</a>
