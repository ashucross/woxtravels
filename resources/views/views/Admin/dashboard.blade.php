		...
		<div class="container-fluid">
			...
			<div class="dashboard_status_list">
				...
				<div class="row dash_box">
					...
					<div class="col-12 col-sm-6 col-md-3">
						<a href="#"><div class="info-box">
							<span class="info-box-icon TourPackages_c elevation-1"><i class="fas fa-glass"></i></span>
							<div class="info-box-content">
								<span class="info-box-number">Tour Packages</span>
								<span class="info-box-text">Refunds</span>
							</div>
					...
					<div class="col-12 col-sm-6 col-md-3">
						<a href="#"><div class="info-box">
							<span class="info-box-icon Visa_c elevation-1"><i class="fas fa-globe"></i></span>
							<div class="info-box-content">
					...
					<div class="col-12 col-sm-6 col-md-3">
						<a href="#"><div class="info-box">
							<span class="info-box-icon Insurance_c elevation-1"><i class="fas fa-umbrella"></i></span>
							<div class="info-box-content">
								<span class="info-box-number">Insurance</span>
								<span class="info-box-text">Refunds</span>
							</div>
					...
					<div class="col-12 col-sm-6 col-md-3">
						<a href="#"><div class="info-box">
							<span class="info-box-icon CarRentals_c elevation-1"><i class="fas fa-car"></i></span>
							<div class="info-box-content">
								<span class="info-box-number">Car Rentals</span>
								<span class="info-box-text">Refunds</span>
							</div>
			...
			$hotelbooking = \App\HotelBookingDetail::where('status', 1)->count();			
				...
				<div class="row dash_box">
					<div class="col-12 col-sm-6 col-md-3">
						<a href="{{URL::to('/bookings?status=1')}}"><div class="info-box">
							<span class="info-box-icon bg-danger elevation-1"><i class="fas fa-plane"></i></span>
							<div class="info-box-content">
								<span class="info-box-number">Flight</span>
					...
					<div class="col-12 col-sm-6 col-md-3">
						<a href="{{URL::to('/bookings?btype=hotel&type=b2c&status=1')}}"><div class="info-box">
							<span class="info-box-icon bg-info elevation-1"><i class="fas fa-bed"></i></span>
							<div class="info-box-content">
								<span class="info-box-number">Hotel</span>
			...
			$hotelbookingfailed = \App\HotelBookingDetail::where('status', 2)->count();			
				...
				<div class="row dash_box">
					<div class="col-12 col-sm-6 col-md-3">
						<a href="{{URL::to('/bookings?status=2')}}"><div class="info-box">
							<span class="info-box-icon bg-danger elevation-1"><i class="fas fa-plane"></i></span>
							<div class="info-box-content">
								<span class="info-box-number">Flight</span>
					...
					<div class="col-12 col-sm-6 col-md-3">
						<a href="{{URL::to('/bookings?btype=hotel&type=b2c&status=2')}}"><div class="info-box">
							<span class="info-box-icon bg-info elevation-1"><i class="fas fa-bed"></i></span>
							<div class="info-box-content">
								<span class="info-box-number">Hotel</span>
