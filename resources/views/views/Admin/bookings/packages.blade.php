								...
								<ul>
									<li>
										...
										<div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 31px, 0px);">
										  <a class="dropdown-item" tabindex="-1" href="{{URL::to('/bookings')}}?btype=package">B2C Booking</a>
										  <a class="dropdown-item" tabindex="-1" href="{{URL::to('/bookings')}}?type=b2b&btype=package">B2B Booking</a>
										</div>											
									</li>
								</ul>
							</div>
