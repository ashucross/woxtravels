				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header">
							...
							?>
									<li style="cursor:pointer;" onClick="window.location.href='{{URL::to('/bookings/?status=1&btype=hotel')}}'" class="active_tag cus_tag">
										<span class="span_tag approvetag">{{@$suucessb}}</span> <span class="tag_label">Success
										<small class="approvetag"> {{@$suucessb}}</small></span>
										
									</li>
									<li style="cursor:pointer;"  onClick="window.location.href='{{URL::to('/bookings/?status=2&btype=hotel')}}'" class="inactive_tag cus_tag">
										<span class="span_tag pendingtag">{{@$failedb}}</span> <span class="tag_label">Failed 
										<small class="pendingtag"> {{@$failedb}}</small></span>
									</li>
									<li style="cursor:pointer;"  onClick="window.location.href='{{URL::to('/bookings/?status=0&btype=hotel')}}'" class="inactive_tag cus_tag">
								...
								<ul>
									<li>
										...
										<div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 31px, 0px);">
										  <a class="dropdown-item" tabindex="-1" href="{{URL::to('/bookings')}}?btype=hotel">B2C Booking</a>
										  <a class="dropdown-item" tabindex="-1" href="{{URL::to('/bookings')}}?type=b2b&btype=hotel">B2B Booking</a>
										</div>											
									</li>
								</ul>
							</div>
									...
									<tr>
										...
										<div class="check_status">
											...
											@else
												Pending
											@endif</a>
											<span><a href="{{URL::to('/hotellog/'.base64_encode(convert_uuencode(@$bookdetail->id)))}}" target="_blank" class="view_log">View Log</a></span>
											</div>
										</td>
										<td>
										<div class="check_status">
										...
										<td><div class="nav-item dropdown action_dropdown">
												...
												<div class="dropdown-menu">
													<a href="{{URL::to('/bookings/hoteldetail/'.base64_encode(convert_uuencode(@$bookdetail->id)))}}"><i class="fa fa-edit"></i> View Detail</a>
