							...
							<div class="company_logos_sec">
									...
									<div class="col-sm-6">
										<div class="profile_img_field">
											...
											<div class="comp_img">
												@if(@Auth::user()->company_pancard == '') 
												@else
												<img src="{{URL::to('/public/img/agentdoc')}}/{{@$fetchedData->company_pancard}}" class="img-avatar" alt="" />
												@endif
											</div>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="profile_img_field">
											...
											<div class="comp_img">
												...
												@else
												<img src="{{URL::to('/public/img/agentdoc')}}/{{@$fetchedData->aadhaar_card}}" class="img-avatar" alt="" />
												@endif
											</div>
										</div>
									</div>	
								...
								<!--<div class="col-sm-6"> 
									<div class="form-group"> 
										<b for="first_name">Pan Card</b>
										<?php //if(@$fetchedData->company_pancard != ''){
											?>
											<a  href="{{URL::to('/public/img/agentdoc')}}/{{@$fetchedData->company_pancard}}" target="_blank"><img width="100" height="100" src="{{URL::to('/public/img/agentdoc')}}/{{@$fetchedData->company_pancard}}"></a>
											<?php
										//} ?>
									</div>
								</div>
								<div class="col-sm-6"> 
									<div class="form-group"> 
										<b for="first_name">Aadhaar Card</b>
										<?php //if(@$fetchedData->aadhaar_card != ''){
											?>
											<a href="{{URL::to('/public/img/agentdoc')}}/{{@$fetchedData->aadhaar_card}}" target="_blank"><img src="{{URL::to('/public/img/agentdoc')}}/{{@$fetchedData->aadhaar_card}}" width="100" height="100"></a>
											<?php
										//} ?>
									</div>
								</div>-->
