...
<div class="content-wrapper">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Manage Amenities</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					...
					<div class="card"> 
						<div class="card-header">   
							<div class="card-title">
								<a href="{{route('admin.manageamenities.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> New Amenities</a> 
								<a style="display:none;" class="btn btn-primary displayifselected" href="javascript:;" onClick="deleteAllAction('amenities')"><i class="fa fa-trash"></i> Delete</a> 
							</div> 
						...
						<div class="card-body table-responsive">
							<table id="amenitytable" class="table table-bordered table-hover text-nowrap">
							  <thead>
								<tr>
								  ...
								  <td>
									<div class="nav-item dropdown action_dropdown">
										...
										<div class="dropdown-menu">
											<a href="{{URL::to('/amenities/edit/'.base64_encode(convert_uuencode(@$list->id)))}}"><i class="fa fa-edit"></i> Edit</a>
...
<div class="modal fade" id="amnetsearch_modal">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<form action="{{route('admin.manageamenities.index')}}" method="get">
				<div class="modal-body"> 
					<div class="row">
						<div class="col-md-6">
							<div class="form-group row">
								<label for="amenity" class="col-sm-2 col-form-label">ID</label>
								<div class="col-sm-10">
									{{ Form::text('amenity', Request::get('amenity'), array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'ID', 'id' => 'amenity' )) }}
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group row">
								<label for="name" class="col-sm-2 col-form-label">Amenities Name</label>
								<div class="col-sm-10">
				...
				<div class="modal-footer justify-content-between">
				  <a href="{{route('admin.manageamenities.index')}}" class="btn btn-default" >Reset</a>
