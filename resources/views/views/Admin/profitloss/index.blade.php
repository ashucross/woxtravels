					...
					<div class="card"> 
						<div class="card-header">   
							...
							<div class="print_export">
								<ul>
									<li class="print"><a dataurl="{{URL::to('/profitloss')}}?type={{@$_GET['type']}}&action=print" href="javascript:;" class="print_myinvoice"><i class="fas fa-print"></i> Print</a></li>
									<li class="export"><a href="{{URL::to('/profitloss')}}?type={{@$_GET['type']}}&action=excel"><i class="fas fa-file-excel"></i> Export</a></li>
								</ul>
							</div>	 
						</div>
