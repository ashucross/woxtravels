								...
								<div id="tabs">
									<div class="nav flex-column nav-tabs h-100 custom_nav_tabs" id="vert-tabs-tab" role="tablist" aria-orientation="horizontal">
									 ...
									 <div class="tab-content custom_tab_content" id="vert-tabs-tabContent">
									  ...
									  {{ Form::open(array('url' => 'settings/api/store', 'name'=>"add-package", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")) }}
										<div class="row">
											<div class="col-sm-6">
									   ...
									   {{ Form::open(array('url' => 'settings/api/hotelstore', 'name'=>"add-twillo", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")) }}
										<div class="row">
											<div class="col-sm-6">
												<div class="form-group"> 
