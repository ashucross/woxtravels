								...
								<div id="tabs">
									<div class="nav flex-column nav-tabs h-100 custom_nav_tabs" id="vert-tabs-tab" role="tablist" aria-orientation="horizontal">
									 ...
									 <div class="tab-content custom_tab_content" id="vert-tabs-tabContent">
									  ...
									  {{ Form::open(array('url' => 'settings/payment-gateway/store', 'name'=>"add-package", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")) }}
										<div class="row">
											<div class="col-sm-6">
									   ...
									   <div class="tab-pane text-left" id="vert-tabs-paypal" role="tabpanel" aria-labelledby="vert-tabs-paypal-tab">
										{{ Form::open(array('url' => 'settings/payment-gateway/store', 'name'=>"add-razor", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")) }}
											<div class="row">
												<div class="col-sm-6">
												<div class="form-group"> 
