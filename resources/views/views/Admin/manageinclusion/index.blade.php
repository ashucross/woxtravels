...
@section('title', 'Manage Inclusion')
...
<div class="content-wrapper">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Manage Inclusion</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">Home</a></li>
						<li class="breadcrumb-item active">Manage Inclusion</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
					...
					<div class="card"> 
						<div class="card-header">  
							<div class="card-title">
								<a href="{{route('admin.manageinclusion.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> New Inclusion</a>
								 <a style="display:none;" class="btn btn-primary displayifselected" href="javascript:;" onClick="deleteAllAction('inclusions')"><i class="fa fa-trash"></i> Delete</a>
							</div> 
								  ...
								  <td>
									<div class="nav-item dropdown action_dropdown">
										...
										<div class="dropdown-menu">
											<a href="{{URL::to('/inclusion/edit/'.base64_encode(convert_uuencode(@$list->id)))}}"><i class="fa fa-edit"></i> Edit</a>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				  <h4 class="modal-title">Inclusion Search</h4>
				  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				  </button>
			</div>
			<form action="{{route('admin.manageinclusion.index')}}" method="get">
				<div class="modal-body"> 
					<div class="row">
						<div class="col-md-6">
							<div class="form-group row">
								<label for="inc_id" class="col-sm-2 col-form-label">ID</label>
								<div class="col-sm-10">
									{{ Form::text('inc_id', Request::get('inc_id'), array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'ID', 'id' => 'inc_id' )) }}
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group row">
								<label for="name" class="col-sm-2 col-form-label">Inclusion Name</label>
								<div class="col-sm-10">
				...
				<div class="modal-footer justify-content-between">
				  <a href="{{route('admin.manageinclusion.index')}}" class="btn btn-default" >Reset</a>
