					...
					<div class="card"> 
						<div class="card-header">   
							<div class="card-title">
								<a href="{{route('admin.testimonial.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> New Testimonial</a> 
							</div> 
								  ...
								  <td>
									<div class="nav-item dropdown action_dropdown">
										...
										<div class="dropdown-menu">
											<a href="{{URL::to('/testimonial/edit/'.base64_encode(convert_uuencode(@$list->id)))}}"><i class="fa fa-edit"></i> Edit</a>
											<a href="javascript:;" onClick="deleteAction({{@$list->id}}, 'testimonials')"><i class="fa fa-trash"></i> Delete</a>	
										</div>
									</div> 
								  </td>
								</tr>	
