			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="card card-primary">
					  ...
					  <!-- /.card-header -->
					  <!-- form start -->
					  {{ Form::open(array('url' => 'testimonial/store', 'name'=>"add-template", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")) }}
						...
						<div class="card-body">
							<div class="form-group" style="text-align:right;">
								...
								{{ Form::button('<i class="fa fa-save"></i> Save Testimonial', ['class'=>'btn btn-primary', 'onClick'=>'customValidate("add-template")' ]) }}
							</div>
