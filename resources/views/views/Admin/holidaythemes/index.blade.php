...
@section('title', 'Manage Holiday Themes')
					...
					<div class="card"> 
						<div class="card-header">   
							<div class="card-title">
								<a href="{{route('admin.themes.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> New Holiday Themes</a>
								<a style="display:none;" class="btn btn-primary displayifselected" href="javascript:;" onClick="deleteAllAction('holiday_themes')"><i class="fa fa-trash"></i> Delete</a> 
							</div> 
								  ...
								  <td>
									<div class="nav-item dropdown action_dropdown">
										...
										<div class="dropdown-menu">
											<a href="{{URL::to('/themes/edit/'.base64_encode(convert_uuencode(@$list->id)))}}"><i class="fa fa-edit"></i> Edit</a>
