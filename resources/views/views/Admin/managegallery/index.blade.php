							...
							<table class="table table-hover text-nowrap">
							  ...
							  <tbody class="tdata">	
								...
								<tr id="id_{{@$list->id}}"> 
								  ...
								  <td><a href="{{URL::to('/gallery/edit/'.base64_encode(convert_uuencode(@$list->id)))}}"><i class="fa fa-edit"></i> Edit</a> / <a href="javascript:;" onClick="deleteAction({{@$list->id}}, 'galleries')"><i class="fa fa-trash"></i> Delete</a>
								  </td>
								</tr>	
								@endforeach						
							  </tbody>
