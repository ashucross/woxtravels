					...
					<div class="col-md-12">
						<div class="card card-primary">
							<div class="card-header">
								<h3 class="card-title">New Contacts</h3>
							</div>
						  <!-- /.card-header -->
							<div class="card-body">
								<div class="form-group" style="text-align:right;">
									...
									{{ Form::button('<i class="fa fa-save"></i> Save Contact', ['class'=>'btn btn-primary', 'onClick'=>'customValidate("add-contacts")' ]) }}
								</div> 	 
								...
								<div class="form-group row">  
									...
									<div class="col-sm-10">
										{{ Form::text('anniversary_date', '', array('class' => 'form-control commodate', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Anniversary Date' )) }}
										<div class="calendar_icon"><i class="fa fa-calendar"></i></div>
								...
								<div class="form-group row"> 
									...
									<div class="col-sm-4">
									{{ Form::text('contact_phone', '', array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Mobile Phone *' )) }}
									...
									<div class="col-sm-4">
									{{ Form::text('work_phone', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Work Phone' )) }}
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
									{{ Form::text('website', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'http://' )) }}
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
									{{ Form::text('designation', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Designation' )) }}
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
									{{ Form::text('department', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Department' )) }}
						...
						<div class="card card-primary">
							...
							<div class="card-body">
								<div class="form-group row"> 
									...
									<div class="col-sm-9">
									{{ Form::text('skype_name', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Skype ID' )) }}
								...
								<div class="form-group row"> 
									...
									<div class="col-sm-9">
									{{ Form::text('facebook_name', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Facebook ID' )) }}
								...
								<div class="form-group row"> 
									...
									<div class="col-sm-9">
									{{ Form::text('twitter_name', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Twitter ID' )) }}
								...
								<div class="form-group row"> 
									...
									<div class="col-sm-9">
									{{ Form::text('linkedin_name', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Linkedin ID' )) }}
								...
								<div class="form-group row"> 
									...
									<div class="col-sm-9">
									{{ Form::text('instagram_name', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Instagram ID' )) }}
								...
								<div class="form-group row"> 
									...
									<div class="col-sm-9">
									{{ Form::text('youtube_name', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Youtube ID' )) }}
						...
						<div class="card card-primary">
							...
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<textarea name="address" class="form-control" placeholder="Address" style="width: 100%; height:80px;padding: 10px;margin-bottom:10px;"></textarea>
								...
								<div class="form-group row"> 
									...
									<div class="col-sm-9">
									{{ Form::text('city', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'City Name' )) }}
									@if ($errors->has('city'))
										<span class="custom-error" role="alert">
								...
								<div class="form-group row"> 
									...
									<div class="col-sm-9">
									{{ Form::text('zipcode', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Zipcode' )) }}
								...
								<div class="form-group row"> 
									...
									<div class="col-sm-9">
									{{ Form::text('phone', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Phone Number' )) }}
									@if ($errors->has('phone'))
										<span class="custom-error" role="alert">
