    ...
    <span class="sr-only">Next</span>
			...
			<div class="banner-center-box">
							<ul class="plani-icon">
								...
								<li><i class="fa fa-bed"></i> HOTELS</li>
							</ul>
							<div class="banner-reservation-tabs custom_reservation_tab">
								<ul class="br-tabs">
									<li class="active" dataway="oneway">
										<a href="javascript:;">	
                               ...
                               <ul class="award">
								...
								<ul class="br-tabs-content" style="height: 100%;">
									...
									<div class="ismultipleway">
										<form action="http://24hr.lightmytrip.com/FlightList/index" class="form-banner-reservation form-inline style-2 form-h-50">
											...
											<div class="form-group cus_calendar_field CLI">
												<input autocomplete="off" type="text" name="brTimeStart" value="" class="form-control htl" id="datepicker-time-start" placeholder="2019/09/30">
												<i class="far fa-calendar add"></i>
											</div><!-- .form-group end -->
											<div class="form-group hideifmulticity cus_calendar_field CLI">
												<input autocomplete="off" readonly type="text" name="brTimeEnd" value="" class="form-control htl if_oneway_trip roundtripenable" id="datepicker-time-end" placeholder="2019/09/30">
												<i class="far fa-calendar add"></i>
											</div><!-- .form-group end -->
									...
									<div class="ismultipleway" id="section-s1">
										...
										<span>From</span>
											...
											<div class="form-group cus_calendar_field">
												<input autocomplete="off" type="text" name="brTimeStart" value="" class="form-control htl" id="multipicker1"
										...
										<span>From</span>
											...
											<div class="form-group cus_calendar_field">
												<input autocomplete="off" type="text" name="brTimeStart" value="" class="form-control htl" id="multipicker2"
													placeholder="2019/09/30">
												<i class="far fa-calendar add"></i>
											</div><!-- .form-group end -->
										...
										<span>From</span>
											...
											<div class="form-group cus_calendar_field">
												<input autocomplete="off" type="text" name="brTimeStart" value="" class="form-control htl " id="multipicker3"
													placeholder="2019/09/30">
												<i class="far fa-calendar add"></i>
											</div><!-- .form-group end -->
										...
										<i class="fas fa-plane"></i>
											...
											<div class="form-group cus_calendar_field">
												<input autocomplete="off" type="text" name="brTimeStart" value="" class="form-control htl" id="multipicker4"
													placeholder="2019/09/30">
												<i class="far fa-calendar add"></i>
											</div><!-- .form-group end -->
										...
										<i class="fas fa-plane"></i>
											...
											<div class="form-group cus_calendar_field">
												<input autocomplete="off" type="text" name="brTimeStart" value="" class="form-control htl" id="multipicker5"
													placeholder="2019/09/30">
												<i class="far fa-calendar add"></i>
											</div><!-- .form-group end -->
										...
										<i class="fas fa-plane"></i>
											...
											<div class="form-group cus_calendar_field">
												<input autocomplete="off" type="text" name="brTimeStart6" value="" class="form-control htl" id="multipicker6"
													placeholder="2019/09/30">
												<i class="far fa-calendar add"></i>
											</div><!-- .form-group end -->
								...
								<div class="advanced_option"><a href="javascript:;">Previous searches&nbsp;<i class="fas fa-chevron-down"></i></a>
                ...
                <div class="row"> 
                    <div class="col-md-12">
                        <div class="section-title cus_sec_title">
                            <h2>Today's <strong>Flight Deals</strong><img src="images/check.png" class="imgres"></h2>
        ...
        <section class="section_content recommended_international_tour common_recommend_slider serps">
            <div class="container"> 
                <div class="row"> 
                    <div class="col-md-12">
                        <div class="section-title cus_sec_title">
                            <h2>Hotel<strong> in Popular Locations</strong></h2>
...
<div class="dcard">
	...
	<div class="newsl_txt">
		...
		<div class="imgdown">
			<a href="#">
				<img src="images/g.jpg" class="imgres"/>
			</a>
			<a href="#">
				<img src="images/a.jpg" class="imgres"/>
			</a>
		</div>
