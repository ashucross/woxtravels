					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="booking_confrm_icons">
								<ul>
									<li><a href="#"><img src="{!! asset('public/images/hotel_img/print.png') !!}" alt="Booking Print"/></a></li>
									<li><a href="#"><img src="{!! asset('public/images/hotel_img/share.png') !!}" alt="Booking Share"/></a></li>
									<li><a href="#"><img src="{!! asset('public/images/hotel_img/email.png') !!}" alt="Booking Email"/></a></li>
								</ul>
							</div>
						</div>						
						<div class="col-sm-6">	
									...
									<table class="table">
										<tbody>
											...
											<tr>	
												...
												<td><small><b>travel24her.com Pvt Ltd</b></small></td>
											</tr>	
											<tr>	
					...
					<div class="row">
						<div class="col-sm-12 other_detail_info">
							...
							<div class="emergency_contact">
								...
								<div class="guest_col book_cus_col">
									<ul>
										<li>Agent Contact Number: 09122195512</li>
										<li>Service Operator Number: +91 - 09122195512 (24X7 India Helpline Number)</li>
									</ul>
								</div>
							</div>
