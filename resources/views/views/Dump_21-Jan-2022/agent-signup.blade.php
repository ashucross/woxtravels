...
<div class="col-sm-4 col-xs-12 agent_sidebar">
	<div class="sidebar_item">
		<h4><i class="fa fa-phone fa-rotate-90"></i> Need Help?</h4>
		<div class="sidebar-item-body">
			<div class="need_txt">
				<p>Need Help? Call us or drop a message. Our agents will be in touch shortly.</p>
				<ul>
					<li><i class="fa fa-phone fa-rotate-90"></i> <a href="tel:(+91)-09122195512">(+91)-09122195512</a></li>
					<li><i class="fa fa-envelope"></i> <a href="mailto:info@travel24her.com">info@travel24her.com</a></li>
				</ul>
			</div>
		</div>
	</div>
	<div class="sidebar_item why_sidebar_item">
		<h4><i class="fa fa-file"></i> Why Book With Us</h4>
		<div class="sidebar-item-body">
			<div class="cus_item_box">
				<div class="col-md-2 col-xs-3 padd0">
					<img src="{!! asset('public/images/rupee-inr.png') !!}" alt="Images">
				</div>
				<div class="col-md-10 col-xs-9">
					<h5>No Service Fees </h5>
			...
			<div class="cus_item_box">
				<div class="col-md-2 col-xs-3 padd0">
					<img src="{!! asset('public/images/online-booking.png') !!}" alt="Images">
				</div>
				<div class="col-md-10 col-xs-9">
					<h5>Easy and Fast Booking</h5>
			...
			<div class="cus_item_box">
				<div class="col-md-2 col-xs-3 padd0">
					<img src="{!! asset('public/images/credit-card.png') !!}" alt="Images">
				</div>
				<div class="col-md-10 col-xs-9">
					<h5>Trusted Payment System</h5>
			...
			<div class="cus_item_box">
				<div class="col-md-2 col-xs-3 padd0">
					<img src="{!! asset('public/images/experts.png') !!}" alt="Images">
				</div>
				<div class="col-md-10 col-xs-9">
					<h5>Travel Experts to You</h5>
