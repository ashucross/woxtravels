						...
						<div class="inner_contact">	  
							...
							<!--<div class="enquiry_info">
								<div class="col-sm-4">	  
									...
									<p><a href="mailto:info@Travel24hr.com.com">info@Travel24hr.com.com</a></p>
								</div>
								<div class="col-sm-4">	  
									<h5><i class="fa fa-phone"></i> Phone</h5>
									<p><a href="tel:(+91)-11-47262626">(+91)-11-47262626</a></p>
								</div>
								<div class="col-sm-4">	  
									<h5><i class="fa fa-map-marker"></i> Address</h5>
									<p>Zap Booking Private Limited<br> F111/112 North Square Mall,<br>Netaji subhash place complex,<br>Delhi – 110034, India</p>
								</div>
							</div>-->
						</div>
					</div>	
