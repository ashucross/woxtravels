						...
						<div class="inner_hotel_detail">	  
							...
							<div class="col-md-9 col-sm-12">	 
									...
									<div class="traveller_details">
										...
										<div class="contact_info">
											...
											<div class="gst_details">
												...
												<div class="check_box">
													<label>
														<input data-valid="required" type="checkbox" name="gst"/> I understand and agree to the rules of this fare, and the <a href="#" class="loadtc" target="_blank">Terms &amp; Conditions </a> of Travel24her.com Booking
													</label>
												</div>
											</div> 
								...
								<?php if(isset($detail->hotel->rates[$rm]->rate_comments)){ ?>
									<div class="essential_info" style="border-bottom: 10px solid #e8e8e8;padding: 15px;">
									...
									<div class="side_box inner_sidebar">
										<div class="price_sec">
											...
											?>	</span></li>
												...
												<?php
											if(isset($detail->hotel->rates[$rm])){
												?>{{$detail->hotel->rates[$rm]->price_details->GST[2]->amount}}
												<?php
											}else if(isset($detail->hotel->rate)){
												?>{{$detail->hotel->rate->price_details->GST[2]->amount}}<?php
											}
											?>	</span></li>
...
<?php
											if(isset($detail->hotel->rates[$rm])){
												?>{{$detail->hotel->rates[$rm]->price}}
												<?php
											}else if(isset($detail->hotel->rate)){
												?>
												{{$detail->hotel->rate->price}}
												<?php
											}
											?></span></li>
											<?php
