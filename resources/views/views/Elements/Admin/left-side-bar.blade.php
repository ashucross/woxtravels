			   ...
			   with font-awesome or any other icon font library -->
				...
				<li class="nav-item has-treeview {{@$bookingclasstype}}">
					...
					<ul class="nav nav-treeview">
						...
						<li class="nav-item {{(Route::currentRouteName() == 'admin.bookings.index' && Request::get('btype') == 'hotel') ? 'active' : ''}}">
							<a href="{{URL::to('/bookings?btype=hotel')}}" class="nav-link">
								<i class="far fa-circle nav-icon"></i>
								<p>Hotels</p>
							</a>
						</li>
						...
						<li class="nav-item {{(Route::currentRouteName() == 'admin.bookings.index' && Request::get('btype') == 'package') ? 'active' : ''}}">
							<a href="{{URL::to('/bookings?btype=package')}}" class="nav-link">
								<i class="far fa-circle nav-icon"></i>
								<p>Packages</p>
							</a>
						</li>
						<li class="nav-item {{(Route::currentRouteName() == 'admin.visa.index' && Request::get('btype') == 'visa') ? 'active' : ''}}">
							<a href="{{URL::to('/visa?btype=visa')}}" class="nav-link">
								<i class="far fa-circle nav-icon"></i>
								<p>Visa</p>
							</a>
						</li>
				...
				<li class="nav-item has-treeview {{@$Financeclasstype}}">
					...
					<ul class="nav nav-treeview">
						...
						<li class="nav-item">
							<a href="#" class="nav-link">
								<i class="far fa-circle nav-icon"></i>
								<p>Approved Deposits Transaction</p>
							</a>
						</li>
						<li class="nav-item">
							<a href="#" class="nav-link">
				...
				<li class="nav-item has-treeview {{@$flightclasstype}}"> 
					...
					<ul class="nav nav-treeview">
						...
						<li class="nav-item {{(Route::currentRouteName() == 'admin.flightsapis.index' || Route::currentRouteName() == 'admin.flightsapis.create' || Route::currentRouteName() == 'admin.flightsapis.edit') ? 'active' : ''}}">
							<a href="{{route('admin.flightsapis.index')}}" class="nav-link">
								<i class="far fa-circle nav-icon"></i>
								<p>Flights APIs</p>
							</a>
						</li>
			...
			<?php
				...
				<li class="nav-item has-treeview {{@$settingclasstype}}"> 
					...
					<ul class="nav nav-treeview">
						...
						<li class="nav-item {{(Route::currentRouteName() == 'admin.site_information.index') ? 'active' : ''}}">
							<a href="{{route('admin.site_information.index')}}" class="nav-link">
								<i class="far fa-circle nav-icon"></i>
								Site Information
							</a>
						</li>
...
<!--<div class="sidebar">
	<nav class="sidebar-nav">
		<ul class="nav">
			<li class="nav-item">
				<a class="nav-link {{Route::currentRouteName() == 'admin.edit_seo' ? 'active' : ''}}" href="{{URL::to('/dashboard')}}">
			...
			<li class="nav-item nav-dropdown {{Route::currentRouteName() == 'admin.edit_course' ? 'open' : ''}}">
				...
				<ul class="nav-dropdown-items">
					<li class="nav-item">
						<a class="nav-link" href="{{URL::to('/add_course')}}">
						<i class="nav-icon icon-plus"></i> Add Course</a>
					</li>
					<li class="nav-item">
						<a class="nav-link {{Route::currentRouteName() == 'admin.edit_course' ? 'active' : ''}}" href="{{URL::to('/courses')}}">
