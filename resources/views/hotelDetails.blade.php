...
<div class="container_pd">
            ...
            <div class="col-sm-12">
                <div class="top_txt_price d-flex justify-content-between align-items-center">
                    <div class="left_top_txt">
                        <h1>Park Avenue Baker Street London
                    ...
                    <div class="price_right">
                        <h2><i class="fa fa-dollar mr-1"></i>25,447</h2>
            ...
            <div class="col-sm-8">
                ...
                <section class="discription_para  page-section" id="section1">
                    ...
                    <div class="hegitbx para_dis">
                        <p>The 4-star Park Central Hotel offers comfort and convenience whether you're on business or holiday in New York (NY). Featuring a complete list of amenities, guests will find their stay at the property a comfortable one. Service-minded
                            staff will welcome and guide you at the Park Central Hotel. Air conditioning, heating, desk, alarm clock, iPod docking station can be found in selected guestrooms. The hotel offers various recreational opportunities. Park Central
                            Hotel combines warm hospitality with a lovely ambiance to make your stay in New York (NY) unforgettable.</p>
                        <p>The 4-star Park Central Hotel offers comfort and convenience whether you're on business or holiday in New York (NY). Featuring a complete list of amenities, guests will find their stay at the property a comfortable one. Service-minded
                            staff will welcome and guide you at the Park Central Hotel. Air conditioning, heating, desk, alarm clock, iPod docking station can be found in selected guestrooms. The hotel offers various recreational opportunities. Park Central
                            Hotel combines warm hospitality with a lovely ambiance to make your stay in New York (NY) unforgettable.</p>
                    </div>
        ...
        <span class="fa fa-angle-down"></span> View More
                    ...
                    <div class="largebox_listing">
                        <div class="lglist">
                            <div class="list_hotel_img">
                                <div class="lgzoomimg">
                                    <a href="#">
                                        <img src="{{url('assets/images/Hera.jpg')}}" class="img-res" />
                                    </a>
                                </div>
                            </div>
                            ...
                            Deluxe Twin Room</span>
                                    ...
                                    <ul class="iconsml">
                                        ...
                                        <li>
                                            ...
                                            <span><img src="{{url('assets/images/FreeParking.png')}}" class="img-res" /></span>
                                        ...
                                        <li>
                                            ...
                                            <span><img src="{{url('assets/images/Restaurant.png')}}" class="img-res" /></span>
                    ...
                    <div class="amtbox">
                        ...
                        <div class="amt_icon d-flex flex-wrap">
                            <div class="amities_rpt d-flex">
                                <span class="imgblack"><img src="{{url('assets/images/Wifi_b.svg')}}" alt="" class="imgres " /></span>
                                <span class="imagewhite"><img src="{{url('assets/images/Wifi_w.svg')}}" alt="" class="imgres " /></span>
                                <h3>Wifi</h3>
                            </div>

                            <div class="amities_rpt d-flex">
                                <span class="imgblack"><img src="{{url('assets/images/Wake-upcall_b.svg')}}" alt="" class="imgres " /></span>
                                <span class="imagewhite"><img src="{{url('assets/images/Wake-upcall_w.svg')}}" alt="" class="imgres " /></span>
                                <h3>Wake-up call</h3>
                            </div>

                            <div class="amities_rpt d-flex">
                                <span class="imgblack"><img src="{{url('assets/images/Bathrobes_b.svg')}}" alt="" class="imgres " /></span>
                                <span class="imagewhite"><img src="{{url('assets/images/Bathrobes_w.svg')}}" alt="" class="imgres " /></span>
                                <h3>Bathrobes</h3>
                            </div>

                            <div class="amities_rpt d-flex">
                                <span class="imgblack"><img src="{{url('assets/images/Fitnesscenter_b.svg')}}" alt="" class="imgres " /></span>
                                <span class="imagewhite"><img src="{{url('assets/images/Fitnesscenter_w.svg')}}" alt="" class="imgres " /></span>
                                <h3>Fitness center</h3>
                            </div>

                            <div class="amities_rpt d-flex">
                                <span class="imgblack"><img src="{{url('assets/images/Telephone_b.svg')}}" alt="" class="imgres " /></span>
                                <span class="imagewhite"><img src="{{url('assets/images/Telephone_w.svg')}}" alt="" class="imgres " /></span>
                                <h3>Telephone</h3>
                            </div>

                            <div class="amities_rpt d-flex">
                                <span class="imgblack"><img src="{{url('assets/images/Drycleaning_b.svg')}}" alt="" class="imgres " /></span>
                                <span class="imagewhite"><img src="{{url('assets/images/Drycleaning_w.svg')}}" alt="" class="imgres " /></span>
                                <h3>Dry cleaning</h3>
                            </div>

                            <div class="amities_rpt d-flex">
                                <span class="imgblack"><img src="{{url('assets/images/Minibar_b.svg')}}" alt="" class="imgres " /></span>
                                <span class="imagewhite"><img src="{{url('assets/images/Minibar_w.svg')}}" alt="" class="imgres " /></span>
                                <h3>Mini bar</h3>
                            </div>
            ...
            <div class="col-sm-4 pl0 changehd">
                            ...
                            <div class="">
                                ...
                                <div class="search_date ht_width_dt">
                                    ...
                                    <div class="position-relative ">
                                        ...
                                        <input aut type="text" name="ckein" placeholder="Check-In - Check-Out" class="input_src  input_hgt ">
                ...
                <div class="mapbox">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15544.320449561204!2d80.28291785!3d13.094109150000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a526f509f4372af%3A0xb24f67e09b80003f!2sGeorge%20Town%2C%20Chennai%2C%20Tamil%20Nadu!5e0!3m2!1sen!2sin!4v1665567535064!5m2!1sen!2sin"
