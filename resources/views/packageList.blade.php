...
<div class="modifyhead">
    <div class="mobile-filter">
        <ul>
            ...
            <li>
                <i class="fa fa-plane"></i>BUDGET
            </li>
            <li>
                <i class="fa fa-clock-o"></i>FLIGHTS
            </li>
        </ul>
    </div>
</div>
<div class="container_pd">
    <section class="list_fliter">
            ...
            <div class="filtercnt">
                ...
                <div class="panel-group " id="accordion">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="Hotelrating" class="panel-collapse collapse in show">
                            <div class="panel-body pdmrbx">
                                <div class="checkftr">
                                    <div class="inp_dr">
                                        <input type="text" placeholder="in Nights" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="Facilities" class="panel-collapse collapse in show">
                            <div class="panel-body pdmrbx">
                                <div class="checkftr">
                                    <div class="checkftr">
                                        <div class="inp_dr">
        ...
        <div class="listingbx chan_pckl">
            <div class="rightlist flexdrop">
                <h2>{{$data['location']->name}} Holidays</h2>
                @php
                $citySlug = strtolower(trim(preg_replace('/[^A-Za-z0-9-]+/', '-', $data['location']->name)));
                @endphp
            ...
            <div class="largebox_listing">
                @foreach($data['packages'] as $pckg)
                @php
                $PKG_IMG = "http://admin.eweblinktechnology.com/public/img/media_gallery/".$pckg->package_image;
                @endphp
                <div class="box_lipck">
                    <div class="lglist">
                        ...
                        <div class="list_hotel_txt">
                            <div class="listing_hd_hotel">
                                <h2>
                                    <span>{{$pckg->package_name}}</span>
                                </h2>
                                <ul class="listbt_sml">
                                    <li>
                                        <a href="#">{{$pckg->no_of_nights}} Nights / {{$pckg->no_of_days}} Days</a>
                                    </li>
                                </ul>
                                <ul class="iconsml">
                                    <li>
                                        <span>{{$pckg->details_day_night}}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="pribtns">
                            ...
                            <div class="hotslc btns_ltr ">
                                ...
                                <a href="{{url('package/'.$citySlug.'/'.$pckg->slug)}}" class="btn-grad ftbtn_src">
                                    <i class="fa fa-eye mr-1"></i>View Details </i>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="rmk">
                        <h6>Remarks Get up to Rs 1500 Cashback. Use Coupon</h6>
                        <span>Code: wox2020</span>
                    </div>
                </div>
                @endforeach
            </div>
