			...
			<table style=" border: 1px solid #dee2e6;border-collapse: collapse;" width="100%">
				<tbody>	
					...
					<tr>
						...
						@if(isset($bookingib->Response->Response->FlightItinerary->Passenger))
						Cabin: {{@$bookingib->Response->Response->FlightItinerary->Segments[0]->CabinBaggage }}<br> Check-In: 
						
						{{@$pesib[$ps]->SegmentAdditionalInfo[0]->Baggage}}
					<br> Meal: 
					@endif
						</td>
					</tr>
...
<table style=" border: 1px solid #dee2e6;border-collapse: collapse;" width="100%">
	<tbody>
		...
		<div style="width:100%;display: flex;flex-wrap: wrap;">
			...
			<div style="max-width: 50%;flex: 0 0 50%;position: relative;min-height: 1px;padding-right: 0px;padding-left: 0px;text-align:center;">
				<b>Contact Us</b><br><span><b>Address :</b> {{@$set->company_website}}</span><br><span><b>Support Email :</b> <a href="mailto:booking@zapbooking.com" style="color:#89ad3e;"> {{@$set->b2c_email}}</a></span>
			</div>
		</div>
		<div style="width:100%;display: flex;flex-wrap: wrap;">
			<hr style="border: 1px solid #214a93; width:100%;">
